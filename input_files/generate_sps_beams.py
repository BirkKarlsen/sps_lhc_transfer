...
def sps_generation(args, LXPLUS, lxdir):
    # Parameters -------------------------------------------------------------------------------------------------------
    ...
    matched_from_distribution_density_multibunch(beam, ring, SPS_tracker, distribution_options_list, N_bunches,
                                                 bunch_positions, intensity_list=bunch_intensities,
                                                 n_iterations_input=5, TotalInducedVoltage=total_imp)
    ...
    return beam, profile, dict_settings
